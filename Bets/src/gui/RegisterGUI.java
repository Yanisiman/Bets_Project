...
public class RegisterGUI extends JFrame {
	...
	private final JLabel familyNameLbl = new JLabel("FamilyNameLbl :");
	...
	public RegisterGUI() {
		...
		gbl_panel.rowWeights = new double[] { 1.0, 0.5, 0.0, 0.5, 0.5, 0.5, 0.5, 0.0, 0.5, 0.0, 0.5, 0.0, 0.5, 0.0, 1.0 };
