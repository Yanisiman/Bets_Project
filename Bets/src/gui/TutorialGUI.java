...
public class TutorialGUI extends JFrame {
	...
	/*
		 ...
		 * Runnable() { public void run() { try { TutorialGUI frame = new TutorialGUI();
	...
	*/
	...
	public TutorialGUI() {
		...
		steps.add(
				"Hello and welcome in the Bet&Ruin's tutorial.\nYou will learn how to use the application to be able to bet");
		steps.add(
				"First you need an account. If it's not the case some of the actions described later will not be able to you.");
		steps.add(
				"After selecting a sport you enter in the calendar of events : you can choose a date with events.\nYou can select an event the questions related to it and choose to bet on a answer.");
